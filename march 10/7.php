...
<body>
    <h3></h3>
    <form method="POST">
    <h3>Read an array and count no. of element which are divisible by 5.</h3>
...
if(isset($_POST['submit'])){
    echo"<h3>Read an array and count no. of element which are divisible by 5.</h3>";
    echo"<br>";
    $n1=$_POST['n1'];
    $n2=$_POST['n2'];
    $n3=$_POST['n3'];
    ...
    echo "number of elements which are divisible by 5 : ".$count;
}
?>