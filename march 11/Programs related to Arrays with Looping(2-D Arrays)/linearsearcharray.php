...
<body>
    <h3></h3>
    <form method="POST">
    <h3>Program to find an element in the Array (Linear Searching).</h3>
...
if(isset($_POST['submit'])){
    echo"<h3>Program to find an element in the Array (Linear Searching).</h3>";
    echo"<br>";
    $n1=$_POST['n1'];
    $n2=$_POST['n2'];
    $n3=$_POST['n3'];
    ...
    $x=$_POST['element'];
    echo"searching for element : ".$x;
    echo"<br>";
    $count=0;
    for($i=0;$i<$s;$i++){
        if($array[$i]==$x){
            echo "element is present in array : ".$x;
            $count++;
        }
    }
    if($count==0){
