...
<body>
    <h3></h3>
    <form method="POST">
    <h3>Program to reverse an array without using another array.</h3>
...
if(isset($_POST['submit'])){
    echo"<h3>Program to reverse an array without using another array.</h3>";
    echo"<br>";
    $n1=$_POST['n1'];
    $n2=$_POST['n2'];
    $n3=$_POST['n3'];
    ...
    echo "Reversed array is ".$array[0].",".$array[1].",".$array[2].",".$array[3].",".$array[4];
}
?>